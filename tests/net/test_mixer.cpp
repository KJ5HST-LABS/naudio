...
// normatively at docs/audio-streaming-protocol-v1.md:328 (strict-greater itself is
// stated at :323) — but reachable here because
...
// TX_DENIED is sent once per denial episode (docs/audio-streaming-protocol-v1.md:325),
