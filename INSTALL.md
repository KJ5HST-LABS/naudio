...
> **v1.0.0rc7** (a prerelease), carries everything on this page: the double-click
...
> `gh release download v1.0.0rc7 -R KJ5HST-LABS/naudio` rather than anonymous URLs, and
